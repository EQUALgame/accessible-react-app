...
import round_1_img from '../../assets/colorclash/round1_img.png';
import round_2_img from '../../assets/colorclash/round2_img.png';
import round_3_img from '../../assets/colorclash/round3_img.png';
import round_4_img from '../../assets/colorclash/round4_img.png';
import round_2_bubble from '../../assets/colorclash/round2_bubble.png';
import round_3_bubble from '../../assets/colorclash/round3_bubble.png';
import round_4_bubble from '../../assets/colorclash/round4_bubble.png';
    ...
    <Container fluid className="fullscreen-flex" style={{ backgroundColor: ' #e5e9f2' }}>
      <Card style={{ backgroundColor: CARD_COLOR }}>
        ...
        <Card.Footer className="d-flex justify-content-end">
          <Button size="lg" variant='link' style={{ color: 'black'}} onClick={() => navigate(`/color-clash-play/game/${round}`)}>
            <FaArrowRightLong />
          </Button>
        </Card.Footer>
      </Card>
