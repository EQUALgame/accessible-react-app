...
import ScrambledScriptGame from './games/scrambledscript/Game';
import ScrambledScriptScores from './games/scrambledscript/Scores';
  ...
  return (
    <HashRouter>
      ...
      <Routes>
        ...
        <Route path="/scrambled-script-play/game/:round" element={<ScrambledScriptGame />} />
        <Route path="/scrambled-script-play/recap" element={<ScrambledScriptScores />} />
