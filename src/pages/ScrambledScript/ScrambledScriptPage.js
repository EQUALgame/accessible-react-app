      ...
      <section className="py-5" style={{ backgroundColor: '#E3F2FD', position: 'relative' }}>
        ...
        <Container>
          <div className="text-center mb-5">
            <h1 className="display-4 fw-bold text-dark mb-2">Scrambled Script</h1>
          ...
          <Row className="justify-content-center g-4">
            ...
            <Col md={6} className="text-center">
              ...
              >
                <img
                  src={process.env.PUBLIC_URL + "/icons/scrambledScript/scrambledScriptRound2.svg"}
                  alt="Scrambled Script game illustration"
                  style={{
                    maxWidth: '100%',
                    height: '280px',
                    objectFit: 'contain'
            ...
            <Col md={6} className="text-center">
              ...
              <Button
                as={Link} to="/scrambled-script/learn-more"
                variant="primary"
                size="lg"
                className="mt-3 px-4 py-2 fw-semibold"
                style={{
...
export default ScrambledScriptPage;
