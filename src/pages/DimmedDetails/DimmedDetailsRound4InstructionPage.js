 ...
 * Round 4/4 instruction page for Dimmed Details
...
function DimmedDetailsInstructionPage() {
  ...
  const handleStartGame = () => {
    navigate(`/dimmed-details-play/game/4`);
  };

  return (
    <InstructionPage
      title="Dimmed Details - Round 4/4"
      instructions={instructions}
      imagePath={process.env.PUBLIC_URL + "/icons/dimmedDetails/dimmedDetailsRound4.svg"} 
