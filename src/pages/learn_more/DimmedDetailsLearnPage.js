...
const VISION_MODES = [
  { id: 'Lose central vision', name: 'Lose central vision', img: process.env.PUBLIC_URL + '/icons/dimmedDetails/Lose central vision.png' },
  { id: 'Tunnel vision', name: 'Tunnel vision', img: process.env.PUBLIC_URL + '/icons/dimmedDetails/Tunnel vision.png' },
  { id: 'Poor contrast perception', name: 'Poor contrast perception', img: process.env.PUBLIC_URL + '/icons/dimmedDetails/Poor contrast perception.png' },
];

function DimmedDetailsLearn() {
  const [activeIndex, setActiveIndex] = useState(0); 

  const total = VISION_MODES.length;
    ...
    <div>
      ...
      <section style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
        ...
        {(() => {
          ...
          const prev = !isFirst ? VISION_MODES[activeIndex - 1] : null;
          const curr = VISION_MODES[activeIndex];
          const next = !isLast ? VISION_MODES[activeIndex + 1] : null;
          ...
          const Btn = ({ disabled, onClick, dir }) => {
            ...
            return (
              <button
                ...
                disabled={disabled}
                onClick={onClick}
                aria-label={dir === 'left' ? 'Previous vision mode' : 'Next vision mode'}
                style={{
                  width: 80,               
                  height: 56,
                  borderRadius: 28,        
      ...
      <section>
        ...
        >
          Improving Accessibility for Low Vision
        </h2>
        <p style={{ textAlign: 'center', maxWidth: '820px', margin: '0 auto 1.6rem' }}>
          Users with low vision may not be able to see the world around them. Computer programmers should make their software more accessible for such users by following these guidelines:
        </p>
        ...
        <div style={{ maxWidth: '920px', margin: '0 auto' }}>
          ...
          <DropdownRow
            ...
            openId={openId}
            setOpenId={setOpenId}
            text="2. Allow users to use built-in zooming tools to enlarge the text and graphics"
          >
            <p>
              Zoom-in icons may look like:
            </p>
          ...
          <DropdownRow
            ...
            openId={openId}
            setOpenId={setOpenId}
            text="4. Allow users to change the font size & color contrast level"
          >
            <div style={{ display: 'flex',
                  justifyContent: 'center',
                  alignItems: 'center',
                ...
                <div style={{ textAlign: 'center' }}>
                  <img
                    src={process.env.PUBLIC_URL + "/icons/dimmedDetails/Group 174.png"}
                    alt="First example of a font size & color contrast settings"
                    style={{ width: '85%', maxWidth: '220px', height: 'auto', borderRadius: '8px' }}
                  />
                </div>
                ...
                <div style={{ textAlign: 'center' }}>
                  <img
                    src={process.env.PUBLIC_URL + "/icons/dimmedDetails/Group 175.png"}
                    alt="Second example of a font size & color contrast settings"
                    style={{ width: '100%', maxWidth: '220px', height: 'auto', borderRadius: '8px' }}
                  />
                </div>
            </div>
          ...
          <DropdownRow
            ...
            openId={openId}
            setOpenId={setOpenId}
            text="5. Use alt-text and make your software keyboard-friendly"
          >
            <div style={{ display: 'flex',
                  justifyContent: 'center',
                  alignItems: 'center',
...
export default DimmedDetailsLearn;
