...
const MODES = [
  { id: 'Visual Reliance ', name: 'Visual Reliance ', img: process.env.PUBLIC_URL + '/icons/silentSurfing/Visual Reliance.png' },
  { id: 'Difficultly understanding sound', name: 'Difficultly understanding sound', img: process.env.PUBLIC_URL + '/icons/silentSurfing/Difficultly understanding sound.png' },
  { id: 'Verbal Communication', name: 'Verbal Communication', img: process.env.PUBLIC_URL + '/icons/silentSurfing/Verbal Communication.png' },
];

function SilentSurfingLearn() {
  ...
  const content = (
    <div>
      ...
      <section>
        ...
        >
          Improving Accessibility for Deafness
        </h2>
        <p style={{ textAlign: 'center', maxWidth: '820px', margin: '0 auto 1.6rem' }}>
          Users with deafness may not be able to hear the world around them. Computer programmers should make their software more accessible for such users by following these guidelines:
        </p>
        ...
        <div style={{ maxWidth: '920px', margin: '0 auto' }}>
          <DropdownRow
            ...
            openId={openId}
            setOpenId={setOpenId}
            text="1. Provide transcripts or captions for all audio and videos. "
          >
            <div style={{ display: 'flex',
                ...
                <div style={{ textAlign: 'center' }}>
                  <img
                    src={process.env.PUBLIC_URL + "/icons/silentSurfing/Group 159.png"}
                    alt="Example of video with captions"
          ...
          <DropdownRow
            ...
            openId={openId}
            setOpenId={setOpenId}
            text="2. Don’t use sound effects alone to convey important information.  "
          >
            ...
            <div style={{ display: 'flex',
                ...
                <div style={{ textAlign: 'center' }}>
                  <img
                    src={process.env.PUBLIC_URL + "/icons/silentSurfing/avoid.png"}
                    alt="Avoid example"
                ...
                <div style={{ textAlign: 'center' }}>
                  <img
                    src={process.env.PUBLIC_URL + "/icons/silentSurfing/instead.png"}
                    alt="Instead example"
                    style={{ height: '100%', maxHeight: '220px', width: 'auto', borderRadius: '8px' }}
                  />
                </div>
          ...
          <DropdownRow
            ...
            openId={openId}
            setOpenId={setOpenId}
            text="3. Eliminate background noise from audio."
          >
          <div style={{ display: 'flex',
                  justifyContent: 'center',
                  alignItems: 'center',
                ...
                <div style={{ textAlign: 'center' }}>
                  <img
                    src={process.env.PUBLIC_URL + "/icons/silentSurfing/audio.png"}
                    alt="Avoid example"
                    style={{ height: '100%', maxHeight: '220px', width: 'auto', borderRadius: '8px' }}
                  />
                </div>
                ...
                <div style={{ textAlign: 'center' }}>
                  <img
                    src={process.env.PUBLIC_URL + "/icons/silentSurfing/volume.png"}
                    alt="Instead example"
                    style={{ height: '100%', maxHeight: '220px', width: 'auto', borderRadius: '8px' }}
                  />
                </div>
...
export default SilentSurfingLearn;
