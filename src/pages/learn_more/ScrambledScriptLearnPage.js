...
const MODES = [
  { id: 'Trouble understanding written content', name: 'Trouble understanding written content', img: process.env.PUBLIC_URL + '/icons/scrambledScript/written content.png' },
  { id: 'Slower-paced reading', name: 'Slower-paced reading', img: process.env.PUBLIC_URL + '/icons/scrambledScript/Slower-paced reading.png' },
  { id: 'Mispronunciation', name: 'Mispronunciation', img: process.env.PUBLIC_URL + '/icons/scrambledScript/Mispronunciation.png' },
];

function ScrambledScriptLearn() {
    ...
    <div>
      ...
      <section>
        ...
        <p style={{ textAlign: 'center', maxWidth: '820px', margin: '0 auto 1.6rem' }}>
          Users with dyslexia may not be able to view the world they way others do. Computer programmers should make their software more accessible for such users by following these guidelines:
        </p>
        ...
        <div style={{ maxWidth: '920px', margin: '0 auto' }}>
          <DropdownRow
            ...
            openId={openId}
            setOpenId={setOpenId}
            text="1. Wherever possible, use images, pictures or diagrams to complement text"
          >
          ...
          <DropdownRow
            ...
            openId={openId}
            setOpenId={setOpenId}
            text="4. Use a high-contrast font"
          >
            <div style={{ display: 'flex', justifyContent: 'center', 
              flexWrap: 'wrap',           // ✅ allow wrapping
              gap: '1.5rem',              // smaller gap
...
export default ScrambledScriptLearn;
