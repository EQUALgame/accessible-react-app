      ...
      <section className="py-5" style={{ backgroundColor: '#E3F2FD', position: 'relative' }}>
        ...
        <Container>
          <div className="text-center mb-5">
            <h1 className="display-4 fw-bold text-dark mb-2">Sightless Search</h1>
          ...
          <Row className="justify-content-center g-4">
            ...
            <Col md={6} className="text-center">
              ...
              >
                <img
                  src={process.env.PUBLIC_URL + "/icons/sightlessSearch/sightlessSearchRound2.svg"}
                  alt="Sightless Search game illustration"
                  style={{
                    maxWidth: '100%',
                    height: '280px',
                    objectFit: 'contain'
            ...
            <Col md={6} className="text-center">
              ...
              <Button
                as={Link} to="/sightless-search/learn-more"
                variant="primary"
                size="lg"
                className="mt-3 px-4 py-2 fw-semibold"
                style={{
      ...
      <section id="more-about" className="py-5 border-top">
        <Container className="text-center">
          <h2 className="fw-bold display-6 text-primary mb-4">
            More About Sightless Search
          </h2>
          <p className="fst-italic fs-5" style={{ maxWidth: '1000px', margin: '0 auto' }}>
            Imagine navigating information without sight. This game helps us find better ways support people who are blind through other senses.
          </p>
        </Container>
      </section>
...
export default SightlessSearchPage;
